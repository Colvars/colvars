...
struct rotation_derivative {
  ...
  void prepare_derivative(rotation_derivative_dldq require_dl_dq) {
    ...
    if (require_dl_dq & rotation_derivative_dldq::use_dq) {
      ...
      cvm::real const L0_L1 = 1.0 / (L0 - L1);
      cvm::real const L0_L2 = 1.0 / (L0 - L2);
      cvm::real const L0_L3 = 1.0 / (L0 - L3);

      cvm::real const Q1_s[4] = {L0_L1 * Q1[0], L0_L1 * Q1[1], L0_L1 * Q1[2], L0_L1 * Q1[3]};
      cvm::real const Q2_s[4] = {L0_L2 * Q2[0], L0_L2 * Q2[1], L0_L2 * Q2[2], L0_L2 * Q2[3]};
      cvm::real const Q3_s[4] = {L0_L3 * Q3[0], L0_L3 * Q3[1], L0_L3 * Q3[2], L0_L3 * Q3[3]};

      cvm::real const Q10Q0[4] = {Q1[0] * Q0[0], Q1[0] * Q0[1], Q1[0] * Q0[2], Q1[0] * Q0[3]};
      cvm::real const Q20Q0[4] = {Q2[0] * Q0[0], Q2[0] * Q0[1], Q2[0] * Q0[2], Q2[0] * Q0[3]};
      cvm::real const Q30Q0[4] = {Q3[0] * Q0[0], Q3[0] * Q0[1], Q3[0] * Q0[2], Q3[0] * Q0[3]};

      cvm::real const Q11Q0[4] = {Q1[1] * Q0[0], Q1[1] * Q0[1], Q1[1] * Q0[2], Q1[1] * Q0[3]};
      cvm::real const Q21Q0[4] = {Q2[1] * Q0[0], Q2[1] * Q0[1], Q2[1] * Q0[2], Q2[1] * Q0[3]};
      cvm::real const Q31Q0[4] = {Q3[1] * Q0[0], Q3[1] * Q0[1], Q3[1] * Q0[2], Q3[1] * Q0[3]};

      cvm::real const Q12Q0[4] = {Q1[2] * Q0[0], Q1[2] * Q0[1], Q1[2] * Q0[2], Q1[2] * Q0[3]};
      cvm::real const Q22Q0[4] = {Q2[2] * Q0[0], Q2[2] * Q0[1], Q2[2] * Q0[2], Q2[2] * Q0[3]};
      cvm::real const Q32Q0[4] = {Q3[2] * Q0[0], Q3[2] * Q0[1], Q3[2] * Q0[2], Q3[2] * Q0[3]};

      cvm::real const Q13Q0[4] = {Q1[3] * Q0[0], Q1[3] * Q0[1], Q1[3] * Q0[2], Q1[3] * Q0[3]};
      cvm::real const Q23Q0[4] = {Q2[3] * Q0[0], Q2[3] * Q0[1], Q2[3] * Q0[2], Q2[3] * Q0[3]};
      cvm::real const Q33Q0[4] = {Q3[3] * Q0[0], Q3[3] * Q0[1], Q3[3] * Q0[2], Q3[3] * Q0[3]};

      tmp_Q0Q0_L[0][0][0] = Q10Q0[0] * Q1_s[0] +
                            Q20Q0[0] * Q2_s[0] +
                            Q30Q0[0] * Q3_s[0];
      tmp_Q0Q0_L[1][0][0] = Q10Q0[0] * Q1_s[1] +
                            Q20Q0[0] * Q2_s[1] +
                            Q30Q0[0] * Q3_s[1];
      tmp_Q0Q0_L[2][0][0] = Q10Q0[0] * Q1_s[2] +
                            Q20Q0[0] * Q2_s[2] +
                            Q30Q0[0] * Q3_s[2];
      tmp_Q0Q0_L[3][0][0] = Q10Q0[0] * Q1_s[3] +
                            Q20Q0[0] * Q2_s[3] +
                            Q30Q0[0] * Q3_s[3];

      tmp_Q0Q0_L[0][0][1] = 0.5 * ((Q10Q0[1] + Q11Q0[0]) * Q1_s[0] +
                                   (Q20Q0[1] + Q21Q0[0]) * Q2_s[0] +
                                   (Q30Q0[1] + Q31Q0[0]) * Q3_s[0]);
      tmp_Q0Q0_L[1][0][1] = 0.5 * ((Q10Q0[1] + Q11Q0[0]) * Q1_s[1] +
                                   (Q20Q0[1] + Q21Q0[0]) * Q2_s[1] +
                                   (Q30Q0[1] + Q31Q0[0]) * Q3_s[1]);
      tmp_Q0Q0_L[2][0][1] = 0.5 * ((Q10Q0[1] + Q11Q0[0]) * Q1_s[2] +
                                   (Q20Q0[1] + Q21Q0[0]) * Q2_s[2] +
                                   (Q30Q0[1] + Q31Q0[0]) * Q3_s[2]);
      tmp_Q0Q0_L[3][0][1] = 0.5 * ((Q10Q0[1] + Q11Q0[0]) * Q1_s[3] +
                                   (Q20Q0[1] + Q21Q0[0]) * Q2_s[3] +
                                   (Q30Q0[1] + Q31Q0[0]) * Q3_s[3]);


      tmp_Q0Q0_L[0][0][2] = 0.5 * ((Q10Q0[2] + Q12Q0[0]) * Q1_s[0] +
                                   (Q20Q0[2] + Q22Q0[0]) * Q2_s[0] +
                                   (Q30Q0[2] + Q32Q0[0]) * Q3_s[0]);
      tmp_Q0Q0_L[1][0][2] = 0.5 * ((Q10Q0[2] + Q12Q0[0]) * Q1_s[1] +
                                   (Q20Q0[2] + Q22Q0[0]) * Q2_s[1] +
                                   (Q30Q0[2] + Q32Q0[0]) * Q3_s[1]);
      tmp_Q0Q0_L[2][0][2] = 0.5 * ((Q10Q0[2] + Q12Q0[0]) * Q1_s[2] +
                                   (Q20Q0[2] + Q22Q0[0]) * Q2_s[2] +
                                   (Q30Q0[2] + Q32Q0[0]) * Q3_s[2]);
      tmp_Q0Q0_L[3][0][2] = 0.5 * ((Q10Q0[2] + Q12Q0[0]) * Q1_s[3] +
                                   (Q20Q0[2] + Q22Q0[0]) * Q2_s[3] +
                                   (Q30Q0[2] + Q32Q0[0]) * Q3_s[3]);

      tmp_Q0Q0_L[0][0][3] = 0.5 * ((Q10Q0[3] + Q13Q0[0]) * Q1_s[0] +
                                   (Q20Q0[3] + Q23Q0[0]) * Q2_s[0] +
                                   (Q30Q0[3] + Q33Q0[0]) * Q3_s[0]);
      tmp_Q0Q0_L[1][0][3] = 0.5 * ((Q10Q0[3] + Q13Q0[0]) * Q1_s[1] +
                                   (Q20Q0[3] + Q23Q0[0]) * Q2_s[1] +
                                   (Q30Q0[3] + Q33Q0[0]) * Q3_s[1]);
      tmp_Q0Q0_L[2][0][3] = 0.5 * ((Q10Q0[3] + Q13Q0[0]) * Q1_s[2] +
                                   (Q20Q0[3] + Q23Q0[0]) * Q2_s[2] +
                                   (Q30Q0[3] + Q33Q0[0]) * Q3_s[2]);
      tmp_Q0Q0_L[3][0][3] = 0.5 * ((Q10Q0[3] + Q13Q0[0]) * Q1_s[3] +
      ...
      tmp_Q0Q0_L[0][1][1] = Q11Q0[1] * Q1_s[0] +
                            Q21Q0[1] * Q2_s[0] +
                            Q31Q0[1] * Q3_s[0];
      tmp_Q0Q0_L[1][1][1] = Q11Q0[1] * Q1_s[1] +
                            Q21Q0[1] * Q2_s[1] +
                            Q31Q0[1] * Q3_s[1];
      tmp_Q0Q0_L[2][1][1] = Q11Q0[1] * Q1_s[2] +
                            Q21Q0[1] * Q2_s[2] +
                            Q31Q0[1] * Q3_s[2];
      tmp_Q0Q0_L[3][1][1] = Q11Q0[1] * Q1_s[3] +
                            Q21Q0[1] * Q2_s[3] +
                            Q31Q0[1] * Q3_s[3];

      tmp_Q0Q0_L[0][1][2] = 0.5 * ((Q11Q0[2] + Q12Q0[1]) * Q1_s[0] +
                                   (Q21Q0[2] + Q22Q0[1]) * Q2_s[0] +
                                   (Q31Q0[2] + Q32Q0[1]) * Q3_s[0]);
      tmp_Q0Q0_L[1][1][2] = 0.5 * ((Q11Q0[2] + Q12Q0[1]) * Q1_s[1] +
                                   (Q21Q0[2] + Q22Q0[1]) * Q2_s[1] +
                                   (Q31Q0[2] + Q32Q0[1]) * Q3_s[1]);
      tmp_Q0Q0_L[2][1][2] = 0.5 * ((Q11Q0[2] + Q12Q0[1]) * Q1_s[2] +
                                   (Q21Q0[2] + Q22Q0[1]) * Q2_s[2] +
                                   (Q31Q0[2] + Q32Q0[1]) * Q3_s[2]);
      tmp_Q0Q0_L[3][1][2] = 0.5 * ((Q11Q0[2] + Q12Q0[1]) * Q1_s[3] +
                                   (Q21Q0[2] + Q22Q0[1]) * Q2_s[3] +
                                   (Q31Q0[2] + Q32Q0[1]) * Q3_s[3]);

      tmp_Q0Q0_L[0][1][3] = 0.5 * ((Q11Q0[3] + Q13Q0[1]) * Q1_s[0] +
                                   (Q21Q0[3] + Q23Q0[1]) * Q2_s[0] +
                                   (Q31Q0[3] + Q33Q0[1]) * Q3_s[0]);
      tmp_Q0Q0_L[1][1][3] = 0.5 * ((Q11Q0[3] + Q13Q0[1]) * Q1_s[1] +
                                   (Q21Q0[3] + Q23Q0[1]) * Q2_s[1] +
                                   (Q31Q0[3] + Q33Q0[1]) * Q3_s[1]);
      tmp_Q0Q0_L[2][1][3] = 0.5 * ((Q11Q0[3] + Q13Q0[1]) * Q1_s[2] +
                                   (Q21Q0[3] + Q23Q0[1]) * Q2_s[2] +
                                   (Q31Q0[3] + Q33Q0[1]) * Q3_s[2]);
      tmp_Q0Q0_L[3][1][3] = 0.5 * ((Q11Q0[3] + Q13Q0[1]) * Q1_s[3] +
                                   (Q21Q0[3] + Q23Q0[1]) * Q2_s[3] +
      ...
      tmp_Q0Q0_L[0][2][2] = Q12Q0[2] * Q1_s[0] +
                            Q22Q0[2] * Q2_s[0] +
                            Q32Q0[2] * Q3_s[0];
      tmp_Q0Q0_L[1][2][2] = Q12Q0[2] * Q1_s[1] +
                            Q22Q0[2] * Q2_s[1] +
                            Q32Q0[2] * Q3_s[1];
      tmp_Q0Q0_L[2][2][2] = Q12Q0[2] * Q1_s[2] +
                            Q22Q0[2] * Q2_s[2] +
                            Q32Q0[2] * Q3_s[2];
      tmp_Q0Q0_L[3][2][2] = Q12Q0[2] * Q1_s[3] +
                            Q22Q0[2] * Q2_s[3] +
                            Q32Q0[2] * Q3_s[3];

      tmp_Q0Q0_L[0][2][3] = 0.5 * ((Q12Q0[3] + Q13Q0[2]) * Q1_s[0] +
                                   (Q22Q0[3] + Q23Q0[2]) * Q2_s[0] +
                                   (Q32Q0[3] + Q33Q0[2]) * Q3_s[0]);
      tmp_Q0Q0_L[1][2][3] = 0.5 * ((Q12Q0[3] + Q13Q0[2]) * Q1_s[1] +
                                   (Q22Q0[3] + Q23Q0[2]) * Q2_s[1] +
                                   (Q32Q0[3] + Q33Q0[2]) * Q3_s[1]);
      tmp_Q0Q0_L[2][2][3] = 0.5 * ((Q12Q0[3] + Q13Q0[2]) * Q1_s[2] +
                                   (Q22Q0[3] + Q23Q0[2]) * Q2_s[2] +
                                   (Q32Q0[3] + Q33Q0[2]) * Q3_s[2]);
      tmp_Q0Q0_L[3][2][3] = 0.5 * ((Q12Q0[3] + Q13Q0[2]) * Q1_s[3] +
      ...
      tmp_Q0Q0_L[0][3][3] = Q13Q0[3] * Q1_s[0] +
                            Q23Q0[3] * Q2_s[0] +
                            Q33Q0[3] * Q3_s[0];
      tmp_Q0Q0_L[1][3][3] = Q13Q0[3] * Q1_s[1] +
                            Q23Q0[3] * Q2_s[1] +
                            Q33Q0[3] * Q3_s[1];
      tmp_Q0Q0_L[2][3][3] = Q13Q0[3] * Q1_s[2] +
                            Q23Q0[3] * Q2_s[2] +
                            Q33Q0[3] * Q3_s[2];
      tmp_Q0Q0_L[3][3][3] = Q13Q0[3] * Q1_s[3] +
                            Q23Q0[3] * Q2_s[3] +
                            Q33Q0[3] * Q3_s[3];
    }
  }
