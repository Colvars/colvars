...
struct rotation_derivative {
  ...
  void prepare_derivative(rotation_derivative_dldq require_dl_dq) {
    ...
    if (require_dl_dq & rotation_derivative_dldq::use_dq) {
      ...
      tmp_Q0Q0_L[0][0][1] = 0.5 * ((Q1[0] * Q0[1] + Q1[1] * Q0[0]) / (L0-L1) * Q1[0] +
                                   (Q2[0] * Q0[1] + Q2[1] * Q0[0]) / (L0-L2) * Q2[0] +
                                   (Q3[0] * Q0[1] + Q3[1] * Q0[0]) / (L0-L3) * Q3[0]);
      tmp_Q0Q0_L[1][0][1] = 0.5 * ((Q1[0] * Q0[1] + Q1[1] * Q0[0]) / (L0-L1) * Q1[1] +
                                   (Q2[0] * Q0[1] + Q2[1] * Q0[0]) / (L0-L2) * Q2[1] +
                                   (Q3[0] * Q0[1] + Q3[1] * Q0[0]) / (L0-L3) * Q3[1]);
      tmp_Q0Q0_L[2][0][1] = 0.5 * ((Q1[0] * Q0[1] + Q1[1] * Q0[0]) / (L0-L1) * Q1[2] +
                                   (Q2[0] * Q0[1] + Q2[1] * Q0[0]) / (L0-L2) * Q2[2] +
                                   (Q3[0] * Q0[1] + Q3[1] * Q0[0]) / (L0-L3) * Q3[2]);
      tmp_Q0Q0_L[3][0][1] = 0.5 * ((Q1[0] * Q0[1] + Q1[1] * Q0[0]) / (L0-L1) * Q1[3] +
                                   (Q2[0] * Q0[1] + Q2[1] * Q0[0]) / (L0-L2) * Q2[3] +
                                   (Q3[0] * Q0[1] + Q3[1] * Q0[0]) / (L0-L3) * Q3[3]);


      tmp_Q0Q0_L[0][0][2] = 0.5 * ((Q1[0] * Q0[2] + Q1[2] * Q0[0]) / (L0-L1) * Q1[0] +
                                   (Q2[0] * Q0[2] + Q2[2] * Q0[0]) / (L0-L2) * Q2[0] +
                                   (Q3[0] * Q0[2] + Q3[2] * Q0[0]) / (L0-L3) * Q3[0]);
      tmp_Q0Q0_L[1][0][2] = 0.5 * ((Q1[0] * Q0[2] + Q1[2] * Q0[0]) / (L0-L1) * Q1[1] +
                                   (Q2[0] * Q0[2] + Q2[2] * Q0[0]) / (L0-L2) * Q2[1] +
                                   (Q3[0] * Q0[2] + Q3[2] * Q0[0]) / (L0-L3) * Q3[1]);
      tmp_Q0Q0_L[2][0][2] = 0.5 * ((Q1[0] * Q0[2] + Q1[2] * Q0[0]) / (L0-L1) * Q1[2] +
                                   (Q2[0] * Q0[2] + Q2[2] * Q0[0]) / (L0-L2) * Q2[2] +
                                   (Q3[0] * Q0[2] + Q3[2] * Q0[0]) / (L0-L3) * Q3[2]);
      tmp_Q0Q0_L[3][0][2] = 0.5 * ((Q1[0] * Q0[2] + Q1[2] * Q0[0]) / (L0-L1) * Q1[3] +
                                   (Q2[0] * Q0[2] + Q2[2] * Q0[0]) / (L0-L2) * Q2[3] +
                                   (Q3[0] * Q0[2] + Q3[2] * Q0[0]) / (L0-L3) * Q3[3]);

      tmp_Q0Q0_L[0][0][3] = 0.5 * ((Q1[0] * Q0[3] + Q1[3] * Q0[0]) / (L0-L1) * Q1[0] +
                                   (Q2[0] * Q0[3] + Q2[3] * Q0[0]) / (L0-L2) * Q2[0] +
                                   (Q3[0] * Q0[3] + Q3[3] * Q0[0]) / (L0-L3) * Q3[0]);
      tmp_Q0Q0_L[1][0][3] = 0.5 * ((Q1[0] * Q0[3] + Q1[3] * Q0[0]) / (L0-L1) * Q1[1] +
                                   (Q2[0] * Q0[3] + Q2[3] * Q0[0]) / (L0-L2) * Q2[1] +
                                   (Q3[0] * Q0[3] + Q3[3] * Q0[0]) / (L0-L3) * Q3[1]);
      tmp_Q0Q0_L[2][0][3] = 0.5 * ((Q1[0] * Q0[3] + Q1[3] * Q0[0]) / (L0-L1) * Q1[2] +
                                   (Q2[0] * Q0[3] + Q2[3] * Q0[0]) / (L0-L2) * Q2[2] +
                                   (Q3[0] * Q0[3] + Q3[3] * Q0[0]) / (L0-L3) * Q3[2]);
      tmp_Q0Q0_L[3][0][3] = 0.5 * ((Q1[0] * Q0[3] + Q1[3] * Q0[0]) / (L0-L1) * Q1[3] +
                                   (Q2[0] * Q0[3] + Q2[3] * Q0[0]) / (L0-L2) * Q2[3] +
                                   (Q3[0] * Q0[3] + Q3[3] * Q0[0]) / (L0-L3) * Q3[3]);
      ...
      tmp_Q0Q0_L[0][1][2] = 0.5 * ((Q1[1] * Q0[2] + Q1[2] * Q0[1]) / (L0-L1) * Q1[0] +
                                   (Q2[1] * Q0[2] + Q2[2] * Q0[1]) / (L0-L2) * Q2[0] +
                                   (Q3[1] * Q0[2] + Q3[2] * Q0[1]) / (L0-L3) * Q3[0]);
      tmp_Q0Q0_L[1][1][2] = 0.5 * ((Q1[1] * Q0[2] + Q1[2] * Q0[1]) / (L0-L1) * Q1[1] +
                                   (Q2[1] * Q0[2] + Q2[2] * Q0[1]) / (L0-L2) * Q2[1] +
                                   (Q3[1] * Q0[2] + Q3[2] * Q0[1]) / (L0-L3) * Q3[1]);
      tmp_Q0Q0_L[2][1][2] = 0.5 * ((Q1[1] * Q0[2] + Q1[2] * Q0[1]) / (L0-L1) * Q1[2] +
                                   (Q2[1] * Q0[2] + Q2[2] * Q0[1]) / (L0-L2) * Q2[2] +
                                   (Q3[1] * Q0[2] + Q3[2] * Q0[1]) / (L0-L3) * Q3[2]);
      tmp_Q0Q0_L[3][1][2] = 0.5 * ((Q1[1] * Q0[2] + Q1[2] * Q0[1]) / (L0-L1) * Q1[3] +
                                   (Q2[1] * Q0[2] + Q2[2] * Q0[1]) / (L0-L2) * Q2[3] +
                                   (Q3[1] * Q0[2] + Q3[2] * Q0[1]) / (L0-L3) * Q3[3]);

      tmp_Q0Q0_L[0][1][3] = 0.5 * ((Q1[1] * Q0[3] + Q1[3] * Q0[1]) / (L0-L1) * Q1[0] +
                                   (Q2[1] * Q0[3] + Q2[3] * Q0[1]) / (L0-L2) * Q2[0] +
                                   (Q3[1] * Q0[3] + Q3[3] * Q0[1]) / (L0-L3) * Q3[0]);
      tmp_Q0Q0_L[1][1][3] = 0.5 * ((Q1[1] * Q0[3] + Q1[3] * Q0[1]) / (L0-L1) * Q1[1] +
                                   (Q2[1] * Q0[3] + Q2[3] * Q0[1]) / (L0-L2) * Q2[1] +
                                   (Q3[1] * Q0[3] + Q3[3] * Q0[1]) / (L0-L3) * Q3[1]);
      tmp_Q0Q0_L[2][1][3] = 0.5 * ((Q1[1] * Q0[3] + Q1[3] * Q0[1]) / (L0-L1) * Q1[2] +
                                   (Q2[1] * Q0[3] + Q2[3] * Q0[1]) / (L0-L2) * Q2[2] +
                                   (Q3[1] * Q0[3] + Q3[3] * Q0[1]) / (L0-L3) * Q3[2]);
      tmp_Q0Q0_L[3][1][3] = 0.5 * ((Q1[1] * Q0[3] + Q1[3] * Q0[1]) / (L0-L1) * Q1[3] +
                                   (Q2[1] * Q0[3] + Q2[3] * Q0[1]) / (L0-L2) * Q2[3] +
                                   (Q3[1] * Q0[3] + Q3[3] * Q0[1]) / (L0-L3) * Q3[3]);
      ...
      tmp_Q0Q0_L[0][2][3] = 0.5 * ((Q1[2] * Q0[3] + Q1[3] * Q0[2]) / (L0-L1) * Q1[0] +
                                   (Q2[2] * Q0[3] + Q2[3] * Q0[2]) / (L0-L2) * Q2[0] +
                                   (Q3[2] * Q0[3] + Q3[3] * Q0[2]) / (L0-L3) * Q3[0]);
      tmp_Q0Q0_L[1][2][3] = 0.5 * ((Q1[2] * Q0[3] + Q1[3] * Q0[2]) / (L0-L1) * Q1[1] +
                                   (Q2[2] * Q0[3] + Q2[3] * Q0[2]) / (L0-L2) * Q2[1] +
                                   (Q3[2] * Q0[3] + Q3[3] * Q0[2]) / (L0-L3) * Q3[1]);
      tmp_Q0Q0_L[2][2][3] = 0.5 * ((Q1[2] * Q0[3] + Q1[3] * Q0[2]) / (L0-L1) * Q1[2] +
                                   (Q2[2] * Q0[3] + Q2[3] * Q0[2]) / (L0-L2) * Q2[2] +
                                   (Q3[2] * Q0[3] + Q3[3] * Q0[2]) / (L0-L3) * Q3[2]);
      tmp_Q0Q0_L[3][2][3] = 0.5 * ((Q1[2] * Q0[3] + Q1[3] * Q0[2]) / (L0-L1) * Q1[3] +
                                   (Q2[2] * Q0[3] + Q2[3] * Q0[2]) / (L0-L2) * Q2[3] +
                                   (Q3[2] * Q0[3] + Q3[3] * Q0[2]) / (L0-L3) * Q3[3]);
