...
void colvarmodule::rotation::calc_optimal_rotation_impl() {
  ...
  if (b_debug_gradients) {
    ...
    cvm::log_static("S     = "+cvm::to_str(S_backup_out, cvm::cv_width, cvm::cv_prec)+"\n");
  }
