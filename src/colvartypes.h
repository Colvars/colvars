...
public:
  ...
  inline COLVARS_HOST_DEVICE quaternion(cvm::real x, cvm::real y, cvm::real z)
  ...
  inline COLVARS_HOST_DEVICE void reset_rotation()
  {
    q0 = 1.0;
    q1 = q2 = q3 = 0.0;
  }
  ...
  /// }
  /// @endcode
  inline COLVARS_HOST_DEVICE cvm::quaternion position_derivative_inner(cvm::rvector const &pos,
