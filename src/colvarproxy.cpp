...
int colvarproxy_system::get_dU_dLambda(cvm::real* force)
{
  return cvm::error("Error in get_dU_dLambda: alchemical lambda dynamics is not supported by this build.",
    COLVARS_NOT_IMPLEMENTED);
}
