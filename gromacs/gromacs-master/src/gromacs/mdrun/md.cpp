...
void gmx::Integrator::do_md()
{
    ...
    if (opt2bSet("-colvars",nfile,fnm))
    {
        ...
        gmx::ArrayRef<const std::string> filenames;
        ...
        /* Retrieve filenames */
        filenames = opt2fns("-colvars", nfile, fnm);
        ...
        ir->colvars_proxy->init(ir,ir->init_step,mdatoms, prefix, filenames,filename_restart, cr);
