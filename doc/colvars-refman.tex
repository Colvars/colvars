...
\newcommand{\cvsec}[2]{%
  ...
  \fi
  \hypertarget{#2}{\section*{#1}}\label{#2}\addcontentsline{toc}{section}{#1}
  \ifdefined\HCode
  \HCode{</div>}
  \else
  \end{mdframed}
...
\newcommand{\cvsubsec}[2]{%
  ...
  \begin{mdframed}[backgroundcolor=background-color,linewidth=2pt]
  \fi
  \hypertarget{#2}{\subsection*{#1}}\label{#2}\addcontentsline{toc}{subsection}{\ifdefined\HCode~~~\fi#1}
  \ifdefined\HCode
  \HCode{</div>}
  \else
  \end{mdframed}
...
\newcommand{\cvsubsubsec}[2]{%
  ...
  \begin{mdframed}[backgroundcolor=background-color,linewidth=2pt]
  \fi
  \hypertarget{#2}{\subsubsection*{#1}}\label{#2}\addcontentsline{toc}{subsubsection}{\ifdefined\HCode~~~~~~\fi#1}
  \ifdefined\HCode
  \HCode{</div>}
  \else
  \end{mdframed}
