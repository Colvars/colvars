...
\newcommand{\cvsec}[2]{\noindent\ifdefined\HCode\section{#1}\label{#2}\HCode{<selfref>}\ref{#2}\HCode{</selfref>}\else \hrulefill\section{#1}\label{#2} \fi}
\newcommand{\cvsubsec}[2]{\noindent\ifdefined\HCode\HCode{<selfref>}\ref{#2}\HCode{</selfref>}\else \hrulefill\subsection{#1}\label{#2} \fi}
