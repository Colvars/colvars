...
\newcommand{\cvsec}[2]{\noindent\hrulefill\section{#1}\label{#2}\ifdefined\HCode\HCode{<selfref>}\ref{#2}\HCode{</selfref>}\fi}
\newcommand{\cvsubsec}[2]{\noindent\hrulefill\subsection{#1}\label{#2}\ifdefined\HCode\HCode{<selfref>}\ref{#2}\HCode{</selfref>}\fi}
\newcommand{\cvsubsubsec}[2]{\noindent\hrulefill\subsubsection{#1}\label{#2}\ifdefined\HCode\HCode{<selfref>}\ref{#2}\HCode{</selfref>}\fi}
