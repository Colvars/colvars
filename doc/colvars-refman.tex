...
\newcommand{\cvsec}[2]{\noindent\hyperlink{#2}{\hrulefill}\hypertarget{#2}{\section{#1}}\label{#2}}
\newcommand{\cvsubsec}[2]{\noindent\hyperlink{#2}{\hrulefill}\hypertarget{#2}{\subsection{#1}}\label{#2}}
\newcommand{\cvsubsubsec}[2]{\noindent\hyperlink{#2}{\hrulefill}\hypertarget{#2}{\subsubsection{#1}}\label{#2}}
