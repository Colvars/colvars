...
However, whenever preparing a new simulation input with \texttt{gmx grompp}, users should provide input coordinates where the atoms involved in collective variables are not artificially moved across the boundary conditions, but occupy their relevant relative positions -- usually the nearest ones.
