...
\item %
  \keydef
    ...
    This includes output state files for checkpointing, as well as accumu;ated information such as PMFs or histograms and trajectories of the collective variables.
