...
\item %
  ...
  \key
    ...
    filename}{%
    This option is mutually exclusive with \refkey{mapID}{colvar|mapTotal|mapID}\cvnamdonly{and \refkey{mapName}{colvar|mapTotal|mapName}}; if given, the map will be loaded internally in Colvars, and a Colvars-based atom selections should be given with \refkey{mapName}{colvar|mapTotal|atoms}.
