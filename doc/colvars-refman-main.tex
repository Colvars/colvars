...
Such ranges are often used to define automatically default sampling intervals intervals, for example by setting the parameters \refkey{lowerBoundary}{colvar|lowerBoundary} and \refkey{upperBoundary}{colvar|upperBoundary} in the parent colvar.
