...
The implementation is available as file \texttt{colvartools/pathCV.tcl} in the Colvars distribution.
An example is provided in file \texttt{examples/10\_pathCV.namd}.}
