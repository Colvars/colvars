...
More detailed explanations of the design of the colvars module are provided in G. Fiorin, M. L. Klein and J. H\'enin, \emph{Using collective variables to drive molecular dynamics simulations}, Molecular Physics (2013) (http://dx.doi.org/10.1080/00268976.2013.813594). Please cite this reference whenever publishing work that makes use of this module.
...
\item \keydef{maxForce}{\texttt{abf}}{%
  ...
  {This option enforces a cap on the magnitude of the biasing force effectively applied
   ...
   is kcal/mol divided by the colvar unit (\AA{} for lengths, degrees for angles, etc.).}
