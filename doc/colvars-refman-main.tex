...
\item \texttt{version} : return version of colvars codes
\end{itemize}
...
\begin{itemize}
\item \texttt{colvar $<$name$>$ value} : return the current value of colvar $<$name$>$
\item \texttt{colvar $<$name$>$ update} : recalculate colvar $<$name$>$
\item \texttt{colvar $<$name$>$ type} : return the type of colvar $<$name$>$
\item \texttt{colvar $<$name$>$ delete} : delete colvar $<$name$>$
\cvnamdonly{
\item \texttt{colvar $<$name$>$ addforce $<$F$>$} : apply given force on colvar $<$name$>$
}
\item \texttt{colvar $<$name$>$ getconfig} : return config string of colvar $<$name$>$
\end{itemize}
...
\item \texttt{bias $<$name$>$ getconfig} : return config string of bias $<$name$>$
\end{itemize}
}
}
