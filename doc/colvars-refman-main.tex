...
>>>>>>> f26408b1... Gromacs doc improvements
  }
\end{itemize}
...
\noindent{}Restarting from a previous simulation is done using the \texttt{-colvars\_restart} parameter:\\
...
\noindent{}For the output files, the prefix of colvars output files will be the same as the Gromacs log file. Otherwise, the prefix will be \emph{output}.
}
