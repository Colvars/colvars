...
\item %
  \key
    ...
    \textbf{Note:} \emph{Reading data from a coordinate file may entail an automatic unit conversion if the current length unit is not \AA{}. If this is not the desired behavior, this can be remedied using the \texttt{normalizeVector} option described below.}
  }
