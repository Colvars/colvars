...
\cvsec{Defining collective variables and their physical properties}{sec:colvar}
...
\textbf{Note: }\emph{this is unusually varied combination of selection keywords, demonstrating how they can be combined together: most simulations only use one of them.}\\
