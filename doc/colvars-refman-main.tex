...
\item %
  \labelkey{colvar|distance|oneSiteSystemForce}
  \keydef
    {oneSiteSystemForce}{%
...
\item %
  \dupkey{oneSiteSystemForce}{\texttt{distanceZ}}{colvar|distance|oneSiteSystemForce}{\texttt{distance} component}
\end{cvcoptions}
...
\item %
  \dupkey{oneSiteSystemForce}{\texttt{distanceVec}}{colvar|distance|oneSiteSystemForce}{\texttt{distance} component}
\end{cvcoptions}
...
\item %
  \dupkey{oneSiteSystemForce}{\texttt{distanceDir}}{colvar|distance|oneSiteSystemForce}{\texttt{distance} component}
\end{cvcoptions}
...
\item %
  \dupkey{oneSiteSystemForce}{\texttt{distanceInv}}{colvar|distance|oneSiteSystemForce}{\texttt{distance} component}
\item %
  \keydef
    {exponent}{%
    \texttt{distanceInv}}{%
...
\item %
  \dupkey{oneSiteSystemForce}{\texttt{angle}}{colvar|distance|oneSiteSystemForce}{\texttt{distance} component}
\end{cvcoptions}
...
\item %
  \dupkey{oneSiteSystemForce}{\texttt{dipoleAngle}}{colvar|distance|oneSiteSystemForce}{\texttt{distance} component}
\end{cvcoptions}
...
\item %
  \dupkey{oneSiteSystemForce}{\texttt{dihedral}}{colvar|distance|oneSiteSystemForce}{\texttt{distance} component}
\end{cvcoptions}
...
The potential is minimized when the histogram $h(\xi)$, estimated as a sum of Gaussian functions centered at $(\xi_{1}, \ldots, \xi_{M})$, is close to the reference histogram $h_{0}(\xi)$:
\begin{equation}
...
\item %
  \keydef
    ...
    boolean}{%
    \texttt{off}}{%
    If \texttt{on}, the histogram $h(\xi)$ is write every \texttt{colvarsRestartFrequency} steps to a file with the name \texttt{$<$\outputName$>$.$<$name$>$.hist.dat}}{%
