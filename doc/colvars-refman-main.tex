...
\cvgromacsonly{
\subsection{Running Colvars in Gromacs}
...
\cvnamdonly{This feature is currently available in NAMD, implemented as an interface between Colvars and GridForces\cvnamdugonly{ (see section \ref{section:userdef})}.}
