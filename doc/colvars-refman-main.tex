...
In this use case, \refkey{spinAngle}{colvar|spinAngle} measures the angle of 
rotation around the chosen axis $\mathbf{e}$, whereas 
\refkey{tilt}{colvar|tilt} measures the dot product between $\mathbf{e}$ and 
the actual axis of the full rotation.
