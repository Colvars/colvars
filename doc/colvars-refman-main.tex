...
\cvsubsubsec{\texttt{eulerPhi}: rotation angle along the X-axis from 
references coordinates.}{sec:cvc_eulerPhi}
\labelkey{colvar|eulerPhi}

The complete rotation described by \texttt{orientation} can optionally be 
decomposed into three sub-rotations: (i) $\phi$, the rotation angle from the 
old X-axis to the new X-axis, (ii) $\theta$, the rotation angle from the old 
Y-axis to the new Y-axis and (iii) $\psi$, the rotation angle from the old 
Z-axis to the new Z-axis. This component accepts exactly the same options as 
\texttt{orientation}, and measures the rotation angle from the old X-axis to 
the new X-axis. This angle is expressed in degrees within the periodic range 
$[-180^{\circ}:180^{\circ}]$.
...
\cvsubsubsec{\texttt{eulerTheta}: rotation angle along the Y-axis from 
...
measures the rotation angle from the old Y-axis to the new Y-axis. This angle 
is expressed in degrees within the range $[-90^{\circ}:90^{\circ}]$.
...
\cvsubsubsec{\texttt{eulerPsi}: rotation angle along the Y-axis from 
references coordinates.}{sec:cvc_eulerPsi}
\labelkey{colvar|eulerPsi}

This component accepts exactly the same options as \texttt{orientation}, and 
measures the rotation angle from the old Z-axis to the new Z-axis. This angle 
is expressed in degrees within the periodic range $[-180^{\circ}:180^{\circ}]$.
