...
Alternately, grid parameters can be set directly inside the ABF block by inserting a \texttt{gridParameters} sub-block, as explained in \ref{sec:colvarbias_histogram_grid}.
...
Grid parameters for the histogram may be provided at the level of the individual variables, or via a dedicated configuration block \texttt{gridParameters \{ \ldots \}} inside the configuration of this \texttt{histogram}.
...
\item %
  \simkey{upperBoundaries}{\texttt{gridParameters}}{lowerBoundaries}
\item %
  \simkey{widths}{\texttt{gridParameters}}{lowerBoundaries}
\end{itemize}
