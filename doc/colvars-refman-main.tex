...
The configuration will contain two blocks, one defining the distance variable (see \ref{sec:colvar}, \ref{sec:cvc}), and the other the moving harmonic restraint (\ref{sec:colvarbias_harmonic}).
...
The atom selection syntax is detailed in \ref{sec:colvar_atom_groups}.
