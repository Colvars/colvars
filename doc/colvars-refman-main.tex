...
In any case, the bias list can be used to check the presence of specific biases in a given configuration.
...
Analyzing the above file with standard tools is possible, but laborious.  A \href{https://github.com/Colvars/colvars/blob/master/colvartools/plot_colvars_traj.py?raw=true}{convenience script} for this and related purposes.  It may be used either as a command-line tool or as a Python module:
\begin{mdexampleinput}
...
\item %
  ...
  \keydef
    ...
    This string identifies the bias or analysis method in the output, and to name some output files.
