...
\cvsec{Defining collective variables and their properties}{sec:colvar}
...
\cvsec{Selecting atoms for colvars: defining atom groups}{sec:colvar_atom_groups}
...
\cvsubsec{Selection keywords}{sec:colvar_atom_groups_sel}
...
\cvsec{Collective variable components (basis functions)}{sec:cvc}
