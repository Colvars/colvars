...
\item \textbf{Colvars version 2020-02-25 or later\cvnamdonly{ (NAMD version 2.14b1 or later)}\cvvmdonly{ (VMD version 1.9.4 or later)}.}\\
  The parameter \refkey{hillWidth}{metadynamics|hillWidth} expressing the Gaussian width $\sigma$ does not have a default value any more.  The new parameter \refkey{gaussianSigmas}{metadynamics|gaussianSigmas} also allows setting the $\sigma$ parameters explicitly if more convenient.
