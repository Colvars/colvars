...
\-~~~~\}\\}
\cvlammpsonly{\-~~~~group2 \{ indexGroup Protein\_Calpha\_15-30 \}\\}
\-~~\}\\
\}\\
\\
harmonic \{\\
...
\cvlammpsonly{If the selection is too complex to implement only via internal keywords, an external index file may be created following the format used in GROMACS:\\
\cvurl{http://manual.gromacs.org/documentation/current/user-guide/file-formats.html\#ndx}\\
