...
\begin{itemize}
 \item %
  \key
    ...
    \texttt{calc\_$<$scriptedFunction$>$} should return one scalar,
...
\texttt{colvars}, with the following syntax: \cvnamdonly{\texttt{cv}}\cvvmdonly{\texttt{colvars}}\texttt{~$<$subcommand$>$ [args...]}
...
(e.g. \texttt{calc_colvar_forces}) or in the NAMD config file after a \texttt{run} or
