...
\item The Torch library is required to support the \texttt{torchANN} variable type, which is conditionally compiled if a Torch library is present. \cvgromacsonly{In GROMACS, this is automatically handled by supplying \texttt{-DGMX\_NNPOT=TORCH} in the CMake command line.} 
