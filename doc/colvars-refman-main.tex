...
\begin{itemize}
 \item %
  \key
    ...
    component. If both the function and some of the components are vectors,
    the gradient is really a Jacobian matrix that should be passed as a linear vector
    in row-major order, i.e. for a function $f_i(x_j)$:
    $\nabla_x f_1 \nabla_x f_2 \cdots$.}
...
provided at run time as a Tcl script, in the spirit of \texttt{TclForces}.
