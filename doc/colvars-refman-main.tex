...
Many of the older keywords are still recognized by the current code: the primary purpose of this list is to let you aware of improvements that affect old configuration files.
...
please be aware that \emph{several of these tutorials have not been actively maintained}: while they are updated, the following list will help you reconcile any inconsistencies.
